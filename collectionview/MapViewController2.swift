...
class MapViewController2: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocation(latitude: 13.3532, longitude: 74.7851)
        ...
        let vendor = Vendor(title: "Chai Stall 1", locationName: "Location",
                            coordinate: CLLocationCoordinate2D(latitude: 13.3542, longitude: 74.7852))
        Map.addAnnotation(vendor)
        let vendor1 = Vendor(title: "Chai Stall 2", locationName: "Location",
                             coordinate: CLLocationCoordinate2D(latitude: 13.3527, longitude: 74.7854))
        Map.addAnnotation(vendor1)
        let vendor2 = Vendor(title: "Chai Stall 3", locationName: "Location",
                             coordinate: CLLocationCoordinate2D(latitude: 13.3510, longitude: 74.7849))
...
extension MapViewController2: MKMapViewDelegate {
    // 1
    func mapView2(_ Map: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        // 2
    ...
    func mapView2(_ mapView2: MKMapView, annotationView view: MKAnnotationView,
