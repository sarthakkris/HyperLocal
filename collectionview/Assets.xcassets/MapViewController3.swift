...
class MapViewController3: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let initialLocation = CLLocation(latitude: 13.3475, longitude: 74.7937)
        ...
        let vendor = Vendor(title: "Chai Point 1", locationName: "Location",
                            coordinate: CLLocationCoordinate2D(latitude: 13.3463, longitude: 74.7937))
        Map.addAnnotation(vendor)
        let vendor1 = Vendor(title: "Chai Point 2", locationName: "Location",
                             coordinate: CLLocationCoordinate2D(latitude: 13.3485, longitude: 74.7929))
        Map.addAnnotation(vendor1)
        let vendor2 = Vendor(title: "Chai Point 3", locationName: "Location",
                             coordinate: CLLocationCoordinate2D(latitude: 13.3474, longitude: 74.7928))
